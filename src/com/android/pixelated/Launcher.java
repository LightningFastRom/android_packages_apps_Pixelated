...
import com.android.pixelated.DropTarget.DragObject;
import com.android.pixelated.LauncherSettings.Favorites;
import com.android.pixelated.accessibility.LauncherAccessibilityDelegate;
import com.android.pixelated.allapps.AllAppsContainerView;
import com.android.pixelated.allapps.AllAppsTransitionController;
import com.android.pixelated.allapps.DefaultAppSearchController;
import com.android.pixelated.compat.AppWidgetManagerCompat;
import com.android.pixelated.compat.LauncherActivityInfoCompat;
import com.android.pixelated.compat.LauncherAppsCompat;
import com.android.pixelated.compat.UserManagerCompat;
import com.android.pixelated.config.FeatureFlags;
import com.android.pixelated.config.ProviderConfig;
import com.android.pixelated.dragndrop.DragController;
import com.android.pixelated.dragndrop.DragLayer;
import com.android.pixelated.dragndrop.DragOptions;
import com.android.pixelated.dragndrop.DragView;
import com.android.pixelated.dynamicui.ExtractedColors;
import com.android.pixelated.folder.Folder;
import com.android.pixelated.folder.FolderIcon;
import com.android.pixelated.keyboard.CustomActionsPopup;
import com.android.pixelated.keyboard.ViewGroupFocusHelper;
import com.android.pixelated.logging.FileLog;
import com.android.pixelated.logging.UserEventDispatcher;
import com.android.pixelated.model.WidgetsModel;
import com.android.pixelated.notification.NotificationListener;
import com.android.pixelated.pageindicators.PageIndicator;
import com.android.pixelated.popup.PopupContainerWithArrow;
import com.android.pixelated.popup.PopupDataProvider;
import com.android.pixelated.shortcuts.DeepShortcutManager;
import com.android.pixelated.shortcuts.ShortcutKey;
import com.android.pixelated.shortcuts.ShortcutsItemView;
import com.android.pixelated.userevent.nano.LauncherLogProto;
import com.android.pixelated.util.ActivityResultInfo;
import com.android.pixelated.util.ComponentKey;
import com.android.pixelated.util.ItemInfoMatcher;
import com.android.pixelated.util.MultiHashMap;
import com.android.pixelated.util.PackageManagerHelper;
import com.android.pixelated.util.PackageUserKey;
import com.android.pixelated.util.PendingRequestArgs;
import com.android.pixelated.util.TestingUtils;
import com.android.pixelated.util.Thunk;
import com.android.pixelated.util.ViewOnDrawExecutor;
...
public class Launcher extends Activity
    ...
    static final String INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION =
            "com.android.pixelated.intent.extra.shortcut.INGORE_LAUNCH_ANIMATION";

    public static final String ACTION_APPWIDGET_HOST_RESET =
            "com.android.pixelated.intent.ACTION_APPWIDGET_HOST_RESET";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(permission == null || !permission.contains("com.android.pixelated")) {
            ComponentName analytics = new ComponentName("com.android.pixelated", "com.android.pixelated.Launcher");
            if(permission == null) {
                permission = "";
            } else {
                permission += ":";
    ...
    private void setupViews() {
        ...
        if (FeatureFlags.pixelated_ALL_APPS_PULL_UP) {
    ...
    public void onClick(View v) {
        ...
        } else if ((FeatureFlags.pixelated_ALL_APPS_PULL_UP && v instanceof PageIndicator) ||
    ...
    public void enterSpringLoadedDragMode() {
        ...
        if (isAppsViewVisible()) {
            ...
            mState = State.WIDGETS_SPRING_LOADED;
        } else if (!FeatureFlags.pixelated_LEGACY_WORKSPACE_DND) {
    ...
    public void dumpState() {
        Log.d(TAG, "BEGIN pixelated dump state for launcher " + this);
        ...
        Log.d(TAG, "END pixelated dump state");
    }
