...
import com.android.pixelated.provider.RestoreDbTask;
import com.android.pixelated.util.ManagedProfileHeuristic;
import com.android.pixelated.util.NoLocaleSqliteContext;
...
public class LauncherProvider extends ContentProvider {
    ...
    public static class DatabaseHelper extends SQLiteOpenHelper implements LayoutParserCallback {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            switch (oldVersion) {
                // The version cannot be lower that 12, as pixelated never supported a lower
                // version of the DB.
                case 12: {
